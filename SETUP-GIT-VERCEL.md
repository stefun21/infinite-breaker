...
Install Node.js 22 or newer, extract the archive, and open a terminal inside the extracted `Infinite-Breaker-Supreme-v2.1` folder.
...
git init
git add .
git commit -m "Release Infinite Breaker Supreme Edition v2.1"
git branch -M main
