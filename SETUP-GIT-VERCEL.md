...
Install Node.js 22 or newer, extract the archive, and open a terminal inside the extracted `Infinite-Breaker-v2.0` folder.
...
git init
git add .
git commit -m "Release Infinite Breaker Supreme Edition v2.0"
git branch -M main
